declare module yim {
    ...
    export class getInstance {
         ...
         */
        private constructor(dirtyWordsArray: string[], appKey: string, eventCallback: IEventObject);
        /**
         * 登录
         ...
         * @param callBack 回调
         */
        public startAudioMessage(recvUid: string, chatType: number, callBack: (code: YIMErrorcode, errInfo: { errCode: YIMErrorcode | YIMAudioCode, errMsg: string }) => void): void;
        /**
         * 取消录音
         */
